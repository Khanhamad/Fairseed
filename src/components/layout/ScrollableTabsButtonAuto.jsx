  ...
  return (
    <Box sx={{ maxWidth: {sm:600, md: 774, lg: 1266 }, bgcolor: 'background.paper',}}>
      ...
      >
        ...
        <Tab style={{color:'var(--cool-grey-cool-grey-10, #383A42)',borderRadius: 'var(--Spacing-24, 24px)',border: '1.5px solid rgb(248, 85, 85)',fontFamily:'Satoshi Variable',marginLeft:'0.5rem',fontSize:'14px',fontStyle:'normal'}}  label="Most Supported" />
        <Tab style={{color:'var(--cool-grey-cool-grey-10, #383A42)',borderRadius: 'var(--Spacing-24, 24px)',border: '1.5px solid rgb(248, 85, 85)',fontFamily:'Satoshi Variable',marginLeft:'0.5rem',fontSize:'14px',fontStyle:'normal'}}   label="Women Empowerment" />
        <Tab style={{color:'var(--cool-grey-cool-grey-10, #383A42)',borderRadius: 'var(--Spacing-24, 24px)',border: '1.5px solid rgb(248, 85, 85)',marginLeft:'0.5rem',fontFamily:'Satoshi Variable',fontSize:'14px',fontStyle:'normal'}}   label="NGO Initiatives" />
        <Tab style={{color:'var(--cool-grey-cool-grey-10, #383A42)',borderRadius: 'var(--Spacing-24, 24px)',border: '1.5px solid rgb(248, 85, 85)',marginLeft:'0.5rem',fontFamily:'Satoshi Variable',fontSize:'14px',fontStyle:'normal'}}   label="Religious Studies" />
        <Tab style={{color:'var(--cool-grey-cool-grey-10, #383A42)',borderRadius: 'var(--Spacing-24, 24px)',border: '1.5px solid rgb(248, 85, 85)',marginLeft:'0.5rem',fontFamily:'Satoshi Variable',fontSize:'14px',fontStyle:'normal'}}   label="Expiring Soon" />
        <Tab style={{color:'var(--cool-grey-cool-grey-10, #383A42)',borderRadius: 'var(--Spacing-24, 24px)',border: '1.5px solid rgb(248, 85, 85)',marginLeft:'0.5rem',fontFamily:'Satoshi Variable',fontSize:'14px',fontStyle:'normal'}}   label="Needs Love" />
